...
const trend: EdEn[] = [
  { id: 'Q3 2026', per: 'July to September 2026',
    tese: 'Almost everything the quarter calls aesthetics is, looked at closely, a cost figure: what became cheap to produce, what became expensive to print, and what stopped being controllable on delivery. This edition reads the signals as production economics, not as taste.',
    cor: { tese: 'High-chroma blue because the screen is cheap and the pigment is not',
      ...
      corpo: ['Why now: the cycle elects a cold, high-chroma blue in the same year that inorganic pigment weighs on the budget again and the emissive screen charges nothing for saturation. Horizon: emerging.',
        'WGSN and Coloro named Luminous Blue Colour of the Year 2027 and described the theme governing the five spring/summer 2027 key colours: interconnection between polarities — light and dark, nature and technology, ancient and contemporary, rationality and spirituality.',
        'The less comfortable reading is arithmetic. A blue at that chroma is trivial on a screen — it fits whole inside sRGB and costs nothing extra — and sits near the edge of gamut in four-colour print, where reaching it demands an additional ink or a better substrate. The two colours the forecast describes as a search for purpose, Meadowland Green and Clay, are precisely the ones that survive the cheap process. The year\'s palette is in practice split between what the screen gives away and what paper still delivers.',
        'The absence is worth recording. Purple, which Goethe places at the top of the circle as the colour of dignity and gravity, appears in none of the five. A sector avoiding the top of the circle is avoiding declared hierarchy, and that is a signal about institutional confidence before it is a signal about hue.',
        'Counter-reading: the forecasting houses are market actors and sell subscriptions. A colour of the year announced two years ahead is, first of all, a statement about the publisher\'s own calendar. The signal counts as emerging here only because the same shift towards cold blue appears independently in pigment cost and in screen composition — not because it was announced.',
        'For the instrument: cold high-chroma blue as primary, orange and clay in small area as the characteristic counterpart. Complementary in equal area is the predictable mistake with this combination, and the test that settles it is not taste but contrast measured on both surfaces.'],
      fontes: ['WGSN and Coloro, press release of 29 April 2025', 'Coloro, key colours page', 'WWD, coverage of 29 April 2025', 'Fogra, technical note on gamut coverage in four-colour offset, February 2026', 'ECHA, update to the inorganic pigment register, 12 March 2026'] },
    tipo: { tese: 'Neutrality became cheap, and therefore stopped meaning anything',
      corpo: ['Why now: drawing a competent grotesque stopped being scarce work, and what is abundant distinguishes nobody. Horizon: established for the variable format, faint for the authorship premium.',
        'The variable font standard, published by the W3C in 2017, is infrastructure: browsers, systems and tools handle it without friction, and a whole family arrives in a single file covering weight, optical size, width and experimental axes. That is settled, and the useful question is no longer whether to adopt it but what replaces it.',
        'The aesthetic movement runs the other way from the file economy, and the underlying signal is not taste but expenditure. Studios went back to commissioning and licensing their own designs after a decade resting on open libraries alone. Commissioning type is a capital decision, it shows up in a contract and an invoice, and it is one of the few parts of a visual system that cannot be copied in an afternoon. When differentiation becomes expensive, it becomes proof that somebody chose to pay for it.',
        'Counter-reading: the hand-drawn stroke is being automated faster than it accrues meaning. If irregularity is what proves authorship, it has a short half-life, because irregularity is easy to synthesise and hard to audit. What cannot be synthesised is the editorial decision to keep the same design for ten years.',
        'For the instrument: oddity has to survive the pairing test at text size. An expressive family that works only in display is an accent, not a system, and should be declared as one.'],
      fontes: ['W3C, OpenType Font Variations specification, 2017', 'Monotype, annual Type Trends report', 'Type Directors Club, panel on commissioning and licensing, May 2026', 'Font Trends 2026, market survey and foundry releases'] },
    comb: { tese: 'The flexible palette is not freedom: it is the admission that nobody controls the final surface any more',
      corpo: ['Why now: dark mode, operating-system tinting, feed re-encoding and third-party surfaces took the last word on the pixel away from the author. Horizon: emerging.',
        'The recommendation repeated across identity reports is to abandon the frozen palette in favour of a chromatic theme that shifts by context and platform. Presented as creativity, the change describes a loss more accurately: the fixed palette stopped being applicable because it stopped being executable.',
        'That changes what a colour system needs to deliver. Five hex values are not enough: you need a rule of displacement — how far the hue may turn, how high the chroma may rise, which band of lightness still belongs to the system. It is what a circle with preserved geometry solves and a list of swatches does not.',
        'Counter-reading: a system that accepts any displacement cannot fail, and what cannot fail cannot be verified. Flexibility is auditable only if two quantities stay still: an anchor of value, dark and light, and a contrast threshold that holds at every position in the band. Without those, a flexible identity is merely an indistinguishable one with better vocabulary.'],
      fontes: ['The Branding Journal, identity and design trends 2026', 'It\'s Nice That, graphic trends 2026', 'W3C, WCAG 2.1, success criterion 1.4.3 on minimum contrast'] },
    apl: { tese: 'The grain that proves the hand is the first thing the codec removes',
      corpo: ['Why now: texture took on the argument for authorship exactly when the delivery chain became more aggressive at compressing. Horizon: receding, despite visible adoption.',
        'Identity conceived first in motion became a delivery requirement, and with it came a preference for surface: translucent, waxy, glassy, with visible grain and imperfection. The current reading is that this signs human authorship in an environment saturated with automatic production.',
        'The problem is engineering, not intention. Fine grain is high-frequency noise, and it is exactly what any lossy codec discards first to fit the bit budget. The result is that texture survives where the studio controls the delivery pipeline — print, installation, its own site — and disappears where it does not. Adopting that surface is therefore a statement about how much of distribution you own.',
        'Counter-reading: transparency charges in legibility. A pair that passes the contrast criterion on a flat surface can fail the moment it enters a layer, because the measured colour is no longer the declared colour. Measure the pair in the final composition, not on the swatch.'],
      fontes: ['Three Rooms, eight identity trends for 2026', 'It\'s Nice That, graphic trends 2026', 'Alliance for Open Media, notes on film grain and bit budget in AV1, January 2026'] } },
