---
name: web-dev-system-performance
...
## Escopo e fronteiras
- **Papel condicional:** o Head só o instancia diante de complexidade real de renderização (3D/tempo real) ou budget de CWV estourado. Fora disso, `web-dev-frontend-multistack` + `web-dev-qa-cross-browser` cobrem performance básica.
