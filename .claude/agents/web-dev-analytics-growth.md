...
## Escopo e fronteiras
- Escrita **apenas** em `/content/**` e `/docs/**` (definições de métrica, relatórios). Não escreve código de instrumentação — especifica e entrega ao `web-dev-frontend-multistack`/`web-dev-backend-integration`.
- Uso de dado pessoal em analytics: **consulta** `web-dev-security-privacy`, o Head **decide** e registra em `DECISIONS.md`.
