...
# devops, mobile, motion, web-dev-design-system-engineer, web-dev-system-performance) and the
...
case "$agent_type" in
  web-dev-creative-direction|web-dev-ux-architect|web-dev-ui-designer)
    allowed_re='^(design|docs)/'; allowed_desc='/design ou /docs' ;;
  web-dev-content-seo)
    allowed_re='^content/'; allowed_desc='/content' ;;
  web-dev-analytics-growth)
