...
const NAMES = new Set(['Farbenkreis','ENG','PORT','Zur Farbenlehre','HSL','SVG','PNG','JPG','CSS','SCSS','JSON','Tailwind','SwiftUI','Android XML','Flutter','woff','ttf','otf','@font-face','TREND']);
