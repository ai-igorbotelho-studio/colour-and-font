...
const pairs: [string, string][] = [['--ink', '--ground'], ['--ink', '--panel'], ['--ink', '--field'], ['--ink', '--card'], ['--soft', '--ground'], ['--soft', '--panel'], ['--soft', '--field'], ['--soft', '--card'], ['--rail-ink', '--rail'], ['--rail-soft', '--rail'], ['--rail-on-ink', '--rail-on'], ['--accent-ink', '--accent'], ['--deep', '--ground'], ['--deep', '--panel'], ['--deep', '--card'], ['--deep', '--field']];
